        ...
        do
        {
            ...
            else if(decision == 2)
            {
                ...
                else
                {
                    ...
                    while(posRows < theater.length && !found)
                    {
                    
                        while(posColumns < theater[0].length && !found)
                        {
                        
                            if(theater[posRows][posColumns] == price)
                            {
                            
                                found = true;
                                System.out.println("Selected seat row: " + 
                                        posRows + " columns: " + posColumns);
                                theater[posRows][posColumns] = 0;
                            }
                            else 
                            {
